...
tumorSizeLocationPlot.circle(locationTumorSizeData,tumorSizeRawData,fill_alpha=0.1,size=10);
tumorSizeGenderPlot=figure(x_range=genderKeys,plot_width=700, plot_height=400,title="Tumor Size vs Gender");
tumorSizeGenderPlot.circle(genderTumorSizeData,tumorSizeRawData,fill_alpha=0.1,size=10);
tumorSizeHistologyPlot=figure(x_range=histologyKeys,plot_width=700, plot_height=400,title="Tumor Size vs Histology");
tumorSizeHistologyPlot.circle(histologyTumorSizeData,tumorSizeRawData,fill_alpha=0.1,size=10);
